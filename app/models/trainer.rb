class Trainer < ApplicationRecord
  ...
  validates :fri_end_hour, :presence => true

  validates :fri_end_hour, :numericality => { :greater_than => 0, :less_than_or_equal_to => 12 }
  ...
  validates :fri_start_hour, :numericality => { :greater_than => 0, :less_than_or_equal_to => 12 }

  validates :name, :uniqueness => true

  validates :name, :presence => true

  validates :sat_end_hour, :presence => true
